...
par(mfrow=c(2,2))
plot(hpc2$Global_active_power~hpc2$DateTime,type="l", ylab="Global Active Power",xlab="")
plot(hpc2$Voltage~hpc2$DateTime,type="l", ylab="Voltage",xlab="datetime")
...
legend(x="topright",legend=c("Sub_metering_1","Sub_metering_2","Sub_metering_3"),col=c("black","red","blue"),lwd=1,bty="n",seg.len=1)
plot(hpc2$Global_reactive_power~hpc2$DateTime,type="l", ylab="Global_reactive_power",xlab="datetime")
